...
<!-- jvectormap -->
<script src="<?= base_url(); ?>assets/admin/lugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?= base_url(); ?>assets/admin/lugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?= base_url(); ?>assets/admin/lugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
