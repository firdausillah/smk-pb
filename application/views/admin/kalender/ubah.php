              ...
              <form method="POST" action="">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="deskripsi" placeholder="deskripsi" class="form-control" value="<?= $dt_beranda['deskripsi']; ?>">
                ...
                <div class="row">                
                  <div class="col-md-6">
                    ...
                    <input type="text" name="gambar" class="form-control" placeholder="gambar" value="<?= $dt_beranda['gambar']; ?>">
